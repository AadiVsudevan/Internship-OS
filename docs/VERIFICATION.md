...
- Deployment suite: **117 tests passed**. Hardening adds tests for durable backlog recovery, completed-work weekly budget accounting, rolling deadlines and invalid CTA rejection.
